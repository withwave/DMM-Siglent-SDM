...
- USB 드라이버는 필요 없습니다 (LAN/SCPI raw socket on port 5025).
- VXI-11/RPC 대신 raw SCPI socket을 사용해 RPC 데몬 hang에 영향받지 않습니다. `python-vxi11`/`standard-xdrlib` 등 추가 의존성도 불필요.
...
- DCI AUTO/200mA 레인지에서 안정적인 mA 측정 (예: 64.161 mA)
